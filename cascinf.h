...
public:
  ...
  //xiaoyan
  void PrefixCascade(TCascade& C, TIntFltH& PrefxInfectedNIdH);
  void ReGenCascade(TCascade& C, TIntFltH& InfectedNIdH);
  double F1Score(TCascade& C1, TCascade& C2) const;
